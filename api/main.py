...
from api.routes import discovery, analyzers, generators, presets, jobs, auth, favorites, compositions, workflows, story_tools, stories, characters, configs, tool_configs, local_models, board_games, documents, qa, clothing_items, outfits, visualization_configs, images, cache, tools, tags, merge, entity_previews, brief, comfyui
...
app.include_router(entity_previews.router, prefix="/entity-previews", tags=["entity-previews"])
