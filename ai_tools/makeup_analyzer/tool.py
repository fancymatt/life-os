...
class MakeupAnalyzer:
    ...
    def _load_template(self) -> str:
        ...
        custom_template_path = settings.base_dir / "data" / "tool_configs" / "makeup_analyzer_template.md"
    ...
    async def aanalyze(
        ...
        # Perform analysis
        logger.info(f"🔍 Analyzing makeup in {image_path.name}...")
    ...
    def analyze(
        ...
        """
        Analyze makeup (synchronous wrapper)
    ...
    def save_to_preset(
        ...
        return self.preset_manager.save("makeup", result, display_name=name, notes=notes)
...
Examples:
  ...
  python tool.py --list
    ...
    try:
        ...
        logger.info(f"  {', '.join(result.color_palette)}")
        logger.info("\n" + "="*70)
